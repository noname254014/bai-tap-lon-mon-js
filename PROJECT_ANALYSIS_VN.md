# PHÂN TÍCH DỰ ÁN - Mô Phỏng Thang Máy Web OS

## 1. TỔNG QUAN DỰ ÁN

### 1.1 Mục Đích Dự Án

Dự án này là một **Mô Phỏng Hệ Điều Hành Dựa Trên Web (Web OS)** có tính năng mô phỏng thang máy toàn diện là ứng dụng chính. Hệ thống này thể hiện các kỹ thuật kỹ thuật front-end tiên tiến bao gồm mô phỏng vật lý thời gian thực, thuật toán phân phối đa tiêu chí, và ẩn dụ môi trường desktop hoàn chỉnh.

### 1.2 Vấn Đề Được Giải Quyết

Dự án giải quyết một số thách thức kỹ thuật:
- **Mô phỏng vật lý thời gian thực** của hệ thống thang máy với động học chính xác
- **Thuật toán phân phối đa tiêu chí** (LOOK/SCAN) để gán thang máy tối ưu
...
- **Sinh viên/Nghiên cứu sinh**: Nghiên cứu thuật toán phân phối thang máy và mô phỏng thời gian thực
- **Nhà phát triển**: Học các mẫu JavaScript nâng cao, mô phỏng vật lý, và quản lý trạng thái
- **Kiến trúc sư hệ thống**: Tham chiếu triển khai cho kiến trúc Web OS mô-đun
- **Người dùng khách**: Người dùng thường xuyên khám phá mô phỏng mà không cần xác thực

### 1.4 Mục Tiêu Kinh Doanh Chính

1. Cung cấp mô phỏng thang máy chính xác, tương tác
2. Thể hiện thuật toán phân phối LOOK/SCAN với tham số có thể cấu hình
...
6. Tạo khung Web OS có thể mở rộng cho các ứng dụng bổ sung

### 1.5 Danh Sách Tính Năng Cao Cấp

**Tính Năng Mô Phỏng Thang Máy:**
- Mô phỏng vật lý thời gian thực với tăng tốc/giảm tốc
- Thuật toán phân phối LOOK/SCAN với tính điểm đa tiêu chí
- Phát hiện lỗi (quá tải, kẹt) và phục hồi thủ công
- Trực quan hóa bản đồ nhiệt của mật độ hàng đợi tầng
- Tính toán và hiển thị ETA
- Thuật toán phân vùng cho tòa nhà cao tầng
- Định vị trước cho thang máy rảnh
- Chỉ báo hướng trên màn hình cabin
- UI phản hồi với xử lý điểm ngắt
...
### 2.1 Thuật Toán Phân Phối LOOK/SCAN

#### Mục Đích
Thuật toán LOOK (còn gọi là SCAN) là thuật toán lập lịch đĩa được điều chỉnh cho phân phối thang máy. Nó tối ưu hóa chuyển động thang máy bằng cách phục vụ các yêu cầu theo một hướng cho đến khi không còn yêu cầu theo hướng đó, sau đó đảo ngược.
...
- **Đầu ra:**
  ...
  - Điểm chi phí phân phối để ghi log quyết định
...
#### Mục Đích
Mô phỏng động học thang máy thực tế sử dụng cơ học Newton với tích hợp tăng tốc, vận tốc, và vị trí.
...
- Khớp với thống kê trọng lượng con người thực tế
- Tham số có thể cấu hình
- Phạm vi cập nhật (50-130kg) cho thực tế tốt hơn

### 2.4 Thuật Toán Phân Vùng
